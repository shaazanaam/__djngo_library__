...
from django.conf import (settings)               #  A settings object that allows access to the project settings
from datetime import date                        #  A module that allows the manipulation of dates and times
...
# class Meta is used to  create permissions which can then be used by the administrator to grant access to certain users
    class Meta:
        ordering = ["due_back"]
